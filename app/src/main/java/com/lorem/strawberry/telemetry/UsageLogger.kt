package com.lorem.strawberry.telemetry
...
/**
 * Fire-and-forget usage telemetry, process-wide singleton by design.
 */
object UsageLogger {
    ...
    /** Session token used to authenticate usage logs; the server derives the email from it. */
    ...
    fun logLlmUsage(
        ...
        scope.launch {
            try {
                ...
                val session = sessionToken ?: return@launch
